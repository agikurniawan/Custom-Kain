  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('gudang/tabel_pesanan')?>">Tables</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('gudang/proses_data_pesanan_keluar')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="lokasi" style="margin-left:230px;display:inline;">Jenis </label>
