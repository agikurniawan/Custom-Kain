...
<head>
  ...
  <title>gudang | User Profile</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('gudang/profile')?>" class="active">Profile</a></li>
      </ol>
    </section>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="picture">
                <form class="form-horizontal" action="<?=base_url('gudang/proses_gambar_upload')?>" method="post" enctype="multipart/form-data">
              ...
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal" action="<?=base_url('gudang/proses_new_password')?>" method="post">
