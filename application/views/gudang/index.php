        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a  href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label bg-red"><?=$list_data?></span>

              
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have  
              <span class=""><?=$list_data?></span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span style="padding-right:80px;">Tables</span>
            <span class="label bg-red"><?=$list_data?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('gudang/tabel_pesanan')?>"><i class="fa fa-circle-o"></i> Tabel Pesanan <span class="label bg-red"><?=$list_data?></span></a></li>
          </ul>
...
<!-- notif pesan-->
<script src="<?php echo base_url()?>assets/web_admin/notif/notif.js"></script>
</body>
</html>
