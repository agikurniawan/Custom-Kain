...
<head>
  ...
  <title>Kasir | Pemesanan Kain</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Kasir</b>Uye</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('kasir/form_barangmasuk_b')?>"><i class="fa fa-circle-o"></i> Memesan Baju</a></li>
          </ul>
        </li>
        <li class="treeview ">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('kasir/tabel_barangmasuk_b')?>"><i class="fa fa-circle-o"></i> Pemesanan Baju</a></li>
            <li><a href="<?= base_url('kasir/tabel_satuan')?>"><i class="fa fa-circle-o"></i> Satuan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pemesanan Kain</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Pemesanan Kain</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('kasir/proses_databarang_masuk_insert_b')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:195px;display:inline;">Jenis Kain</label>
                ...
                <div class="form-group" style="display:inline-block;">
                  <label for="nama_Barang" style="width:73%;">Harga</label>
                  <input type="text" name="nama_barang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang" >
              </div>
                <div class="form-group" style="display:inline-block;">
            ...
            <div class="form-group" style="display:inline-block;">
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?=base_url('kasir/tabel_barangmasuk_b')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
