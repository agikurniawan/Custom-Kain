    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('kasir/form_barangmasuk')?>"><i class="fa fa-circle-o"></i> Memesan Kain</a></li>
            <li><a href="<?php echo base_url('kasir/form_satuan')?>"><i class="fa fa-circle-o"></i> Memesan Baju</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
