    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('kasir/tabel_barangmasuk')?>"><i class="fa fa-circle-o"></i> Pemesanan Kain</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Kain Selesai Terjual</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="lokasi" style="margin-left:220px;display:inline;">Jenis Kain</label>
                  <input type="text" name="lokasi" style="margin-left:97px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->lokasi?>">
                </div>
