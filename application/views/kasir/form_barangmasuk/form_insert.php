...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Kasir</b>awe</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('kasir/form_barangmasuk')?>"><i class="fa fa-circle-o"></i> Memesan Kain</a></li>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  ...
                  <select class="form-control" name="lokasi" style="margin-left:75px;width:20%;display:inline;">
                    ...
                    <option value="Tetoron Cutton">Tetoron Cutton</option>
